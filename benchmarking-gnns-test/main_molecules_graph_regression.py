...
def main():    
    ...
    parser.add_argument('--config', help="Please give a config.json file with training/model/data/param details", default='configs/molecules_graph_regression_GAT_ZINC_100k.json')
    parser.add_argument('--gpu_id', help="Please give a value for gpu id", default=None)
    parser.add_argument('--model', help="Please give a value for model name", default=None)
    ...
    parser.add_argument('--seed', help="Please give a value for seed", default=None)
    ...
    parser.add_argument('--pos_enc_dim', help="Please give a value for pos_enc_dim", default=None)
    parser.add_argument('--pos_enc', help="Please give a value for pos_enc", default=None)
