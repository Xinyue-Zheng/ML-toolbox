...
def main():    
    ...
    parser.add_argument('--config', help="Please give a config.json file with training/model/data/param details",
                        default='configs/superpixels_graph_classification_GraphSage_MNIST_100k.json')
    ...
    parser.add_argument('--dataset', help="Please give a value for dataset name", default='MNIST')
