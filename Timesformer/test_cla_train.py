...
def main():
    ...
    def preprocess_function(examples):
        paths = [example for example in examples['path']]
        ...
        result= image_processor(videos, return_tensors="pt")
    ...
    if training_args.do_train:
        ...
        train_dataset = raw_datasets["train"].remove_columns('path')
    ...
    if training_args.do_eval:
        if "validation" not in raw_datasets and "validation_matched" not in raw_datasets:
            ...
            eval_dataset = raw_datasets["validation"].remove_columns('path')
    ...
    if data_args.pad_to_max_length:
        ...
        data_collator = DataCollatorWithPadding(image_processor, pad_to_multiple_of=8)
    else:
        data_collator = None
